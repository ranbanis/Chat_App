...
const MessagePage = ({ navigation, route }) => {
  ...
  const loaddata = async () => {
    AsyncStorage.getItem("user")
      .then(async (value) => {
        fetch("http://192.168.0.104:3000/userdata", {
          method: "POST",
          headers: {
          ...
          .then((data) => {
            if (data.message == "User Found") {
              ...
              fetch("http://192.168.0.104:3000/otheruserdata", {
                method: "POST",
                headers: {
                  "Content-Type": "application/json",
                },
  ...
  const sendMessage = async () => {
    ...
    fetch("http://192.168.0.104:3000/savemessagetodb", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const loadMessages = (temproomid) => {
    fetch("http://192.168.0.104:3000/getmessages", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
